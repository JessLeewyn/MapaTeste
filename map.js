! function(t, e) {
  ...
  options: {
    ...
    icon: true,
    onMove: true,
    template: '{x} | {y}', // https://en.wikipedia.org/wiki/ISO_6709
    projected: false,
  ...
  _getLatLngCoord: function (center) {
    ...
    if (this.options.latlngFormat === 'DM') {
      ...
      lng = 'X: ' + this._format('#0', Math.floor(Math.abs(256 * centerCopy.lng)));
      lat = 'Y: ' + this._format('#0', Math.floor(Math.abs(256 * centerCopy.lat)));
    }
...
L.control.mapCenterCoord = function (options) {
  ...
  function() {
    ...
    t.prototype._createMapFloorLayer = function(t) {
      ...
      }), L.control.mapCenterCoord().addTo(_), L.control.coordinates({
        position: "bottomleft",
        enableUserInput: !1,
