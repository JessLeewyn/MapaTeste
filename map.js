    ...
    function() {
      ...
      var o = {
        ...
        l = function(t, e) {
          ...
          var c2 = "x: " + t.x + "&nbsp;&nbsp;&nbsp;y: " + t.y + "&nbsp;&nbsp;&nbsp;z: " + t.floor;
          var iw = "{{mapa|" + c + "|aqui}}";
          var url;
          document.getElementById("info_coords").innerHTML = c2;
          document.getElementById("wiki").value = url = iw;
          url = "http://www.tibiawiki.com.br/wiki/mapa#" + c;
      ...
      t.prototype._getMapData = function(t, n, o, s) {
        ...
        }), L.control.mapCenterCoord().addTo(m), L.LevelButtons.btns = L.levelButtons({
          layers_widget: p
